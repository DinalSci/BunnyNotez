...
export const AdminPortal = () => {
  ...
  const adminData = api.getAdminPortalData();
  const { students, admins, papers, marks, submissions } = adminData;
  ...
  const navItems = [
    ...
    { id: 'settings', label: 'Cloud & Telegram Config', icon: Settings }
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">
              Upload ongoing papers, evaluate submissions with auto-grading, and manage students across Bio, Chem & Physics.
            </p>
          </div>
